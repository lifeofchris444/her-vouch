  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        >
          The{" "}
          <span className="text-[#860035] font-semibold">Kohl&apos;s</span>{" "}
        ...
        >
          Discover how people are saving on clothing, home essentials, accessories, and everyday items.
        </p>
        ...
        >
          <a
            ...
            className="touch-button group inline-flex items-center gap-3 bg-[#860035] text-white px-8 py-4 rounded-full text-lg font-semibold hover:bg-[#6d002b] transition-all duration-300 hover:shadow-xl hover:shadow-[#860035]/20 hover:-translate-y-0.5"
          >
            APPLY NOW
